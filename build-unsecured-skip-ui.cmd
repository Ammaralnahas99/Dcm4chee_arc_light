...
echo (Skipping UI module in Maven)
echo ========================================
echo.
...
echo Step 2: Building backend with Maven (unsecured, skipping UI module)...
cd C:\Users\USER\dcm4chee-arc-light
call mvn clean install -Ddb=psql -Dsecure=false -DskipTests -pl !dcm4chee-arc-ui2
if errorlevel 1 (
...
echo Step 3: Building UI module only (without clean)...
cd C:\Users\USER\dcm4chee-arc-light\dcm4chee-arc-ui2
call mvn install -DskipTests
if errorlevel 1 (
    echo ERROR: UI module Maven packaging failed!
    pause
    exit /b 1
)
echo.

echo Step 4: Stopping WildFly if running...
taskkill /F /IM java.exe 2>nul
timeout /t 3 >nul
echo.

echo Step 5: Removing OIDC configuration from standalone.xml...
...
echo Step 6: Deploying UNSECURED EAR...
